...
PROJECT_ISSUE_PREFIX = "my-project"  # TEMPLATE: same as setup.sh EXPECTED_PREFIX (beads / Codex ID normalization)
...
def normalize_codex_ids(log: Logger, agent_id: str):
    ...
    Commit message references PROJECT_ISSUE_PREFIX for traceability.
    """
...
examples:
  ...
  ./loop.py --agent claude --loop arch --zone main
